...
// Adapted from motion-primitives: the polymorphic `as` prop was dropped (it built
// a motion component during render, tripping the React Compiler "no components
// during render" rule) — the container always renders a <p>.
